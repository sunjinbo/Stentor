...
/**
 * PlayoutAudioTask class.
 * This class can play a PCM file directly.
 */
public class PlayoutAudioTask extends AudioTask {

    private AudioTrack mAudioTrack;

    public PlayoutAudioTask(Context context, TaskCallback callback) {
    ...
    public void run() {
        ...
        try {
            final File pcm = new File(mContext.getExternalCacheDir(), "sample.pcm");
            if (pcm.exists()) {
